//- присвоить каждому из следующих значений свою переменную: 'hello','owu','com', 'ua', 1, 10,
// -999, 123, 3.14, 2.7, 16, true, false Вывести каждую при помощи console.log , alert, document.write
...
// let one = 2;
// let ten = 20;
// let nineninenine = 1020;
// let onetwothree = 321;
// let pi = 4.32;
// let twopoinseven = 7.2;
// let sixteen = 17;
// let name = false;
// let surname = true;
//
...
// let number1 = Math.round(+prompt());
// let number2 = Math.round(+prompt());
// let number3 = Math.round(+prompt());
//
// console.log(number1, number2, number3);
...
// cars = prompt();
//
// if(colors === 'green' && cars === 'none') {
//     console.log('go');
// }else if(colors === 'green' && cars === 'yes'){
//     console.log('wait while everyone go');
// }else if(colors === 'yellow' && cars === 'yes') {
//     console.log('wait');
// }else if(colors === 'yellow' && cars === 'none') {
//     console.log('wait anyway');
// }else if(colors === 'red' && cars === 'none') {
//     console.log('stop and wait');
// }else if(colors === 'red' && cars === 'yes'){
//     console.log('just stop and wait');
// }else if(colors === 'blicking') {
